...
class DonationContainer extends Component {
  constructor(props) {
    ...
    this.donationMessages = {
      ...
      failure:
        'There seems to have been an error donating money. Please try again later while we sort the glitch.'
    };
    this.state = {
      donationsData: {},
      donationAmt: '',
  ...
  updateDonations(evt) {
    ...
    const selectedSubCause =
      document.getElementById('subcause').selectedIndex + 1;
          ...
          <div className="col-xs-9 mainContentWrapper">
            ...
            <form>
              <div className="select-style">
                <select id="org">
                  {this.state.donationsData.orgs &&
                    this.state.donationsData.orgs.map((org, index) => {
              ...
              <div className="select-style">
                <select id="cause">
                  {this.state.donationsData.causes &&
                    this.state.donationsData.causes.map((causes, index) => {
              ...
              <div className="select-style">
                <select id="subcause">
                  {this.state.donationsData.subCauses &&
                    this.state.donationsData.subCauses.map(
                      (subCauses, index) => {
